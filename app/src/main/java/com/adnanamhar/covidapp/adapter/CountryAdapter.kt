package com.adnanamhar.covidapp.adapter
...
import com.adnanamhar.covidapp.R
import com.adnanamhar.covidapp.model.Negara
...
class CountryAdapter (
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(negara: Negara, clickListener: (Negara) -> Unit){
            ...
            val flag:CircleImageView = itemView.img_flag_cicle
...
//          untuk menampilkan data di layout yang sudah dibuat
            ...
            cTotalDeaths.country_total_death.text = formatter.format(negara.TotalDeaths?.toDouble())
            Glide.with(itemView)
...
//          untuk event klik
    ...
    /* digunakan untuk memberikan fungsi filter,pada projek ini berdasarkan tipe data karakter */
